...
# Read and save the whole html content in a variable

with open('./stages_html/Etage 6.html', 'r') as f:
    html_content = f.read()
f.close()
...
with open('etage6.csv', 'w', newline='') as csvfile:
    csv_writer = csv.writer(csvfile)
    csv_writer.writerows(transposed_grid)

print("CSV file 'etage6.csv' has been created.")

import pandas as pd
import numpy as np

df = pd.read_csv('etage6.csv', header=None)
print(df)